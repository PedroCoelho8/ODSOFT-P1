 ...
 */
    ...
    @Test
    void testSetReturnedWithInvalidVersion() {
        // Cria um novo empréstimo
        Lending notReturnedLending = lendingRepository.save(Lending.newBootstrappingLending(book,
                readerDetails,
                2024,
                3000,
                LocalDate.now(),
        ...
        // Testa o caso onde a versão está incorreta
        var request = new SetLendingReturnedRequest(null);
        assertThrows(StaleObjectStateException.class,
                () -> lendingService.setReturned("2024/3000", request, 999)); // Versão inválida
    }
