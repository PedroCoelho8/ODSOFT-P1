...
class DescriptionTest {
    ...
    @Test
    void ensureDescriptionCanBeNull_thenThrowsException() {
        // Act
    ...
    @Test
    void ensureDescriptionMustNotBeOversize_thenThrowsException() {
        // Arrange

        String expectedMessage = "Description has a maximum of 4096 characters";
    ...
    void ensureDescriptionIsSet() {
        ...
        // Act
        String actualDescription = description.toString();

        // Assert
        assertEquals("Some description", actualDescription, "Description should match the initialized value");
    }
    ...
    void ensureDescriptionCanBeEmpty() {
        ...
        // Act
        Description description = new Description(emptyDescription);
    ...
    void ensureDescriptionCanBeWhitespace() {
        ...
        // Act
        Description description = new Description(whitespaceDescription);
    ...
    void ensureToStringReturnsNullForEmptyDescription() {
        ...
        // Assert
        assertNull(result, "toString should return null for empty description");
    }
