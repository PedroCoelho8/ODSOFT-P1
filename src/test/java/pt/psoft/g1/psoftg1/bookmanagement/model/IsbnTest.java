...
class IsbnTest {
    ...
    @Test
    void ensureIsbn13IsSetCorrect() {
        // Arrange
        String validIsbn13 = "9782826012092";
        Isbn isbn = new Isbn(validIsbn13);

        // Act
        String actualIsbn = isbn.toString();

        // Assert
        assertEquals(validIsbn13, actualIsbn, "ISBN should match the initialized value");
    }
    ...
    @Test
    void ensureChecksum13IsCorrect_() {
        // Arrange
        String invalidIsbn13 = "9782826012099";

        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> new Isbn(invalidIsbn13), "Invalid ISBN-13 checksum");
    }
    ...
    void ensureIsbn10IsSetCorrect() {
        ...
        // Assert
        assertEquals(validIsbn10, actualIsbn, "ISBN should match the initialized value");
    }
    ...
    @Test
    void ensureChecksum10IsCorrect_() {
        // Arrange
        String invalidIsbn10 = "8175257667";

        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> new Isbn(invalidIsbn10), "Invalid ISBN-10 checksum");
    }
